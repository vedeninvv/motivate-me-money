...
//todo В некоторых местах возможно нужно использовать более общие коллекции (вместо List использовать Iterable или что то еще, например). Вообще это надо спросить, наверное...
